...
const EXAMPLES = [
  {
    ...
    description: "Demonstrates recursive call stack depth",
    code: [
  ...
  },
  {
    id: "stack",
    name: "Stack (Push/Pop)",
    description: "Demonstrates push and pop operations",
    code: [
  ...
  },
  {
    ...
    description: "Demonstrates enqueue and dequeue operations",
    code: [
...
function ExampleSelector({ onSelect }) {
  ...
  return (
    <div className="example-selector">
      <button className="btn btn-primary" onClick={() => setOpen((p) => !p)}>
        <span className="btn-icon">&#128218;</span>
        Examples
        <span className="btn-caret">{open ? "\u25B4" : "\u25BE"}</span>
      </button>
      {open && (
        <>
          <div className="example-backdrop" onClick={() => setOpen(false)} />
